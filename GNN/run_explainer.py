...
from data.configs.selector import Selector
from data.replication import replication
...
def main(args):
    ...
    config_path = f"./data/configs/replication/explainers/EVAL/{args.explainer}/{args.dataset}.json"
